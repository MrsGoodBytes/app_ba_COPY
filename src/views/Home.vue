<template>
  <div class="home">
    ...
    <router-link :to="{ name: 'Check' }" href="#" v-if="$route.name !== 'Check'" class="bg-purple-600 text-white text-base font-semibold py-2 px-4 rounded-lg shadow-md hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-purple-200">Welche Anträge sollte ich stellen?</router-link>
  </div>
</template>
